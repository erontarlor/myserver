...
installNextCloud()
{
  ...
  call "echo \"      - OWNCLOUD_OVERWRITE_CLI_URL=https://${certificateDomain[0]}\" >> $compose"
  call "echo \"      - OWNCLOUD_HTACCESS_REWRITE_BASE=/\" >> $compose"
  call "echo \"      - OWNCLOUD_DB_TYPE=mysql\" >> $compose"
  call "echo \"      - OWNCLOUD_DB_NAME=owncloud\" >> $compose"
  ...
  call "echo \"    restart: always\" >> $compose"
  call "echo \"    environment:\" >> $compose"
  call "echo \"      - MARIADB_ROOT_PASSWORD=nextcloud\" >> $compose"
  call "echo \"      - MARIADB_USERNAME=nextcloud\" >> $compose"
  call "echo \"      - MARIADB_PASSWORD=nextcloud\" >> $compose"
  call "echo \"      - MARIADB_DATABASE=nextcloud\" >> $compose"
  call "echo \"      - MARIADB_MAX_ALLOWED_PACKET=128M\" >> $compose"
  call "echo \"      - MARIADB_INNODB_LOG_FILE_SIZE=64M\" >> $compose"
  call "echo \"      - MYSQL_ROOT_PASSWORD=\" >> $compose"
  call "echo \"      - MYSQL_PASSWORD=\" >> $compose"
